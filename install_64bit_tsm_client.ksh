#!/usr/bin/ksh
#
# This script will installs the 64bit TSM client.
#
...
#
#
/usr/lib/instl/sm_inst installp_cmd -a -Q -d '/mnt/client/V52/V5220/64bit' -f 'tivoli.tivguid                                                     ALL  @@I:tivoli.tivguid _all_filesets,tivoli.tsm.client.api.64bit                                  ALL  @@I:tivoli.tsm.client.api.64bit _all_filesets,tivoli.tsm.client.ba.64bit                                   ALL  @@I:tivoli.tsm.client.ba.64bit _all_filesets'  '-c' '-N' '-g' '-X'  '-G'
