...
#
#
/usr/lib/instl/sm_inst installp_cmd -a -l -d '/mnt/client/V52/V523/64bit' -f 'tivoli.tivguid                                                     ALL  @@I:tivoli.tivguid _all_filesets,tivoli.tsm.client.api.64bit                                  ALL  @@I:tivoli.tsm.client.api.64bit _all_filesets,tivoli.tsm.client.ba.64bit                                   ALL  @@I:tivoli.tsm.client.ba.64bit _all_filesets'  '-c' '-N' '-X'   '-F'    
