#!/usr/bin/ksh
#
# This script will reinstall the 32bit TSM client.  This assumes that the proper link of /usr/tivoli to /usr/Tivoli has been properly defined.
#
...
#
#
/usr/lib/instl/sm_inst installp_cmd -a -l -d '/mnt/client/V52/V5220/32bit' -f 'tivoli.tivguid                                                     ALL  @@I:tivoli.tivguid _all_filesets,tivoli.tsm.client.api.32bit                                  ALL  @@I:tivoli.tsm.client.api.32bit _all_filesets,tivoli.tsm.client.ba.32bit                                   ALL  @@I:tivoli.tsm.client.ba.32bit _all_filesets'  '-c' '-N' '-X'   '-F'    
